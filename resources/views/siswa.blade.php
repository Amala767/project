...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- MULAI TOMBOL TAMBAH -->
                <a href="javascript:void(0)" class="btn btn-info" id="tombol-tambah">Tambah SISWA</a>
                <br><br>
                <!-- AKHIR TOMBOL -->
                <!-- MULAI TABLE -->
                <table class="table table-striped table-bordered table-sm" id="table_siswa">
                    <thead>
                        <tr>
                            <th>nis</th>
                            <th>nama siswa</th>
                    ...
                    <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-12 control-label">ttl</label>
                                    <div class="col-sm-12">
    ...
    <script>
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("Tambah Siswa Baru"); //valuenya tambah siswa baru
